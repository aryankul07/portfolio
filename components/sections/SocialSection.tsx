...
const socials = [
  {
    name: "LinkedIn",
    handle: "Aryan Kulshreshtha",
    description: "Professional updates, articles, and industry insights.",
    icon: Linkedin,
    color: "#0a66c2",
    href: "https://www.linkedin.com/in/aryan-kulshreshtha-9820b1325/",
  ...
  },
  {
    ...
    icon: Instagram,
    color: "#e1306c",
    href: "https://www.instagram.com/aryanix_07/",
    bg: "rgba(225,48,108,0.08)",
    border: "rgba(225,48,108,0.3)",
  },
  {
    name: "YouTube",
    handle: "@AryanKulshreshtha-n3m",
    description: "Video essays on business, finance, and entrepreneurship.",
    icon: Youtube,
    color: "#ff0000",
    href: "https://www.youtube.com/@AryanKulshreshtha-n3m",
  ...
  },
  {
    ...
    icon: Github,
    color: "#f0f6fc",
    href: "https://github.com/aryankul07",
  ...
  {
    name: "Email",
    handle: "aryankul2008@outlook.com",
    description: "Collaboration, opportunities, and conversations.",
    icon: Mail,
    color: "#06b6d4",
    href: "mailto:aryankul2008@outlook.com",
